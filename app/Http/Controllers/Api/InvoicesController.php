...
class InvoicesController extends Controller
{
    ...
    {
        $validatedData = $request->validate([
            'order_id' => 'required|exists:orders,_id', // Add this
            'user_id' => 'required|exists:users,_id',   // Add this so the security check works later
            'payment_id' => 'nullable|exists:payments,_id',
            'admin_id' => 'nullable|exists:admins,_id',
            'invoice_number' => 'required|string|max:255|unique:invoices',
            'invoice_create_at' => 'required|date',
        ...
        $validatedData['admin_id'] = auth()->id(); // Assuming the admin is the one creating it
